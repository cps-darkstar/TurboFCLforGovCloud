...
AWS_SERVICE_CONFIG = {
    ...
    "cognito-idp": {"region_name": "us-gov-west-1", "use_ssl": True, "verify": True},
    "secretsmanager": {"region_name": "us-gov-west-1", "use_ssl": True, "verify": True},
    "ssm": {"region_name": "us-gov-west-1", "use_ssl": True, "verify": True},
}
        ...
        "Statement": [
            {
                ...
                "Resource": ["arn:aws-us-gov:s3:::turbofcl-documents-gov/*"],
            },
            {
                "Effect": "Allow",
            ...
            },
            {
                ...
                "Resource": ["arn:aws-us-gov:ssm:us-gov-west-1:*:parameter/turbofcl/*"],
            },
            {
                "Effect": "Allow",
